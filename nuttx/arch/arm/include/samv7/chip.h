...
/* PIC32CZCA90 - 8192 Kbytes FLASH / 1024 Kbytes SRAM
 *
 * These microcontrollers are pin-to-pin compatible with the PIC32CZ CA70
 * family and include a Hardware Security Module (HSM).
 */

#elif defined(CONFIG_ARCH_CHIP_PIC32CZCA90)

#  define SAMV7_FLASH_SIZE (8192*1024)
#  define SAMV7_SRAM_SIZE  (1024*1024)

#  define SAMV7_BSRAM_SIZE (1*1024)

#if defined(CONFIG_ARCH_CHIP_PIC32CZCA90064)
...
#elif defined(CONFIG_ARCH_CHIP_PIC32CZCA90100)
...
#elif defined(CONFIG_ARCH_CHIP_PIC32CZCA90144)
...
#else
#  error "Unknown package of PIC32CZCA90 chip"
#endif
